 ...
 * @author chirag
 */
public class FlightCustomizeTripMobilePage extends
	...
	public FlightTravelerInfoMobilePage continueToTravelerInfo() {
		continueBookingBtn.click();
		FlightTravelerInfoMobilePage flightTravelerInfoPage = new FlightTravelerInfoMobilePage();
